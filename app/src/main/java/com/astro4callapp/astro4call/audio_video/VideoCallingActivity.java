package com.astro4callapp.astro4call.audio_video;
    ...
    private final IRtcEngineEventHandler mRtcEventHandler = new IRtcEngineEventHandler() {
        ...
        public void onJoinChannelSuccess(String channel, final int uid, int elapsed) {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    showLongToast("Join channel success, uid: " + (uid & 0xFFFFFFFFL));
                }
            });
        }
        ...
        public void onUserJoined(final int uid, int elapsed) {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    showLongToast("First remote video decoded, uid: " + (uid & 0xFFFFFFFFL));
        ...
        public void onUserOffline(final int uid, int reason) {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    showLongToast("User offline, uid: " + (uid & 0xFFFFFFFFL));
...
//        mLogView = findViewById(R.id.log_recycler_view);
    ...
    private void showSampleLogs() {
        showLongToast("Welcome to Agora 1v1 video call");
        showLongToast("You will see custom logs here");
        showLongToast("You can also use this to show errors");
    }
    ...
    public void onLocalAudioMuteClicked(View view) {
        ...
        int res = mMuted ? R.drawable.btn_call_shape : R.drawable.btn_unmute_normal;
    ...
    public void onCallClicked(View view) {
        if (mCallEnd) {
            startCall();
            mCallEnd = false;
            mCallBtn.setImageResource(R.drawable.btn_start);
        } else {
            endCall();
            mCallEnd = true;
            mCallBtn.setImageResource(R.drawable.btn_switch_camera_normal);
        }
